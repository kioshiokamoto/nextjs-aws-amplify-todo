				...
				{finished ? (
					...
					>
						<svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
							<circle cx="15" cy="15" r="13" fill="#FAFAFA" stroke="#61A0FF" strokeWidth="4" />
							<path
								fill-rule="evenodd"
								clip-rule="evenodd"
			...
			<div className="flex justify-between w-full my-auto mr-6">
				{finished ? (
					<div className="flex flex-col">
						...
						<div className="text-sm text-gray-700 line-through">{description}</div>
					</div>
				) : (
					<div className="flex flex-col">
								...
								<div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
									<div class="sm:flex">
										<div class="mt-3 text-center sm:mt-0 sm:mx-2 sm:text-left w-full">
											...
											<h3 class="text-sm leading-6 font-medium text-gray-700" id="modal-title">
