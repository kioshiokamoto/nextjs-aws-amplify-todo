	...
	return (
		<>
			...
			<div className="flex flex-col justify-center max-w-4xl mx-auto">
				<div className="my-10 text-6xl text-center text-gray-800">
				...
				<div className="flex flex-col justify-center max-w-md min-w-full mx-auto">
					<div className="flex justify-end w-full max-w-2xl mx-auto mb-2 align-end">
						<button
							className="justify-center w-40 text-xl text-white bg-blue-400 rounded-md hover:bg-blue-600 active:bg-blue-600 h-11"
							onClick={() => {
								setShowModal(true);
							}}
						>
						...
						<button
							className="justify-center w-3 h-5 ml-2 text-xl text-white bg-yellow-300 rounded-md w-11 h-11 hover:bg-yellow-400 active:bg-yellow-400"
							onClick={() => {
								setEditing(!editing);
							}}
						>
